...
const memorialData: MemorialData = {
  ...
  biography:
    "De uma inteligência  invejável, leitora voraz,  desde cedo demonstrou ter uma personalidade própria. Enquanto  suas irmãs faziam magistério ela queria fazer Contabilidade. Como na época era proibido  para mulheres,  preferiu largar a escola e se casar .Uma esposa que soube estar ao lado do marido  conduzindo com sabedoria e inteligência toda a família. Colocava a educação  dos filhos em primeiro  lugar.Era uma mulher de silêncio e extremamente  perspicaz em suas falas ,firme em suas decisões e conselhos. Uma peculiaridade era seu  sorriso fácil.  Por isso  muito  respeitada pelos familiares, amigos e comunidade...Lalae foi referência como mulher de fé, que conduziu filhos nesse caminho espiritual. O terço era sua arma maior. Reunia os filhos desde pequenos em torno dela à noite para rezar o terço. Alem de seu amor incondicional  pelo Sagrado  Coração  de Jesus e Maria,era muito devota de São José e Santo Antônio, que era seu padrinho, já que nasceu  no seu dia. Deixou esse legado também aos netos e próximas gerações.",
  galleryImages: ["foto-lalae.jpeg"],
  siteUrl: "https://remember-qr.vercel.app/", // URL de teste para o QR Code
}
